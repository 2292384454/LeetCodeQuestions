...
public class P893GroupsOfSpecialEquivalentStrings {
    ...
    class Solution {
        public int numSpecialEquivGroups(String[] A) {
            //stringC_count中存储一个个的二维数组c_count
            // c_count[0]和c_count[1]长度都为26，c_count[0]和c_count[1]分别存储奇数位和偶数位26个字母出现的次数
            ArrayList<int[][]> stringC_count = new ArrayList<>();
            Out:
            for (String str : A) {
