...
//Java：二叉搜索树的后序遍历序列687
public class P剑指_offer_33ErChaSouSuoShuDeHouXuBianLiXuLieLcof {
    public static void main(String[] args) {
        Solution solution = new P剑指_offer_33ErChaSouSuoShuDeHouXuBianLiXuLieLcof().new Solution();
        // TO TEST
    }
