 ...
 * </ul>
 * <div><div>Related Topics</div><div><li>字符串</li></div></div><p><div><li>👍 5</li><li>👎 0</li></div>
 */
public class P1910RemoveAllOccurrencesOfASubstring {
    public static void main(String[] args) {
        Solution solution = new P1910RemoveAllOccurrencesOfASubstring().new Solution();
        // TO TEST
    }
    ...
    class Solution {
        public String removeOccurrences(String s, String part) {
            int loc = s.indexOf(part);
            if (loc >= 0) {
                return removeOccurrences(s.substring(0, loc) + s.substring(loc + part.length()), part);
            }
            return s;
        }
    }
