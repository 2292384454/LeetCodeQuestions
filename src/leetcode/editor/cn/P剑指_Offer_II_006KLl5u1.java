 ...
 * <div><div>Related Topics</div><div><li>数组</li><li>双指针</li><li>二分查找</li></div></div><p><div><li>👍 0</li><li>👎 0</li></div>
 */
public class P剑指_Offer_II_006KLl5u1 {
    public static void main(String[] args) {
        Solution solution = new P剑指_Offer_II_006KLl5u1().new Solution();
        // TO TEST
    }
