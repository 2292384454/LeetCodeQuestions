 ...
 * <div><div>Related Topics</div><div><li>树</li><li>深度优先搜索</li><li>二叉树</li></div></div><p><div><li>👍 2</li><li>👎 0</li></div>
 */
public class P剑指_Offer_II_047POCWxh {
    public static void main(String[] args) {
        Solution solution = new P剑指_Offer_II_047POCWxh().new Solution();
        // TO TEST
    }
