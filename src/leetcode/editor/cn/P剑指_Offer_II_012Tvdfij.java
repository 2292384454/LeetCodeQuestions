 ...
 * <div><div>Related Topics</div><div><li>数组</li><li>前缀和</li></div></div><p><div><li>👍 1</li><li>👎 0</li></div>
 */
public class P剑指_Offer_II_012Tvdfij {
    public static void main(String[] args) {
        Solution solution = new P剑指_Offer_II_012Tvdfij().new Solution();
        // TO TEST
