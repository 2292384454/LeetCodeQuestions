 ...
 * <div><div>Related Topics</div><div><li>设计</li><li>队列</li><li>数据流</li></div></div><p><div><li>👍 0</li><li>👎 0</li></div>
 */
public class P剑指_Offer_II_042H8086Q {
    public static void main(String[] args) {
        RecentCounter solution = new P剑指_Offer_II_042H8086Q().new RecentCounter();
        // TO TEST
    }
