 ...
 * </ul>
 * <div><div>Related Topics</div><div><li>数组</li><li>哈希表</li><li>字符串</li><li>有序集合</li><li>排序</li></div></div><p><div><li>👍 22</li><li>👎 0</li></div>
 */
    ...
    class Solution {
        public List<List<String>> displayTable(List<List<String>> orders) {
            ...
            for (List<String> order : orders) {
                ...
                TreeMap<String, Integer> item = map.getOrDefault(tableNumber, new TreeMap<>());
                int count = item.getOrDefault(foodItem, 0);
                item.put(foodItem, count + 1);
            ...
            for (Integer table : tables) {
                ...
                TreeMap<String, Integer> item = map.get(table);
                for (String food : foods) {
                    line.add(String.valueOf(item.getOrDefault(food, 0)));
                }
                ans.add(line);
            }
            return ans;
