...
public class P173BinarySearchTreeIterator {
    public static void main(String[] args) {
        Integer[] vals = new Integer[]{7, 3, 15, null, null, 9, 20};
        TreeNode root = TreeNode.constructTree(vals);
        BSTIterator bstIterator = new P173BinarySearchTreeIterator().new BSTIterator(root);
        // TO TEST
    }
