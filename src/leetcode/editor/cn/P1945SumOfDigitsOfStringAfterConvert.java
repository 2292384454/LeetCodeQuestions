 ...
 * </ul>
 * <div><div>Related Topics</div><div><li>字符串</li><li>模拟</li></div></div><p><div><li>👍 2</li><li>👎 0</li></div>
 */
public class P1945SumOfDigitsOfStringAfterConvert {
    public static void main(String[] args) {
        Solution solution = new P1945SumOfDigitsOfStringAfterConvert().new Solution();
        // TO TEST
        System.out.println(solution.getLucky("leetcodedasdsahkfhaisfalfbalfbaflkahfiafahofalfal", 2));
    }
