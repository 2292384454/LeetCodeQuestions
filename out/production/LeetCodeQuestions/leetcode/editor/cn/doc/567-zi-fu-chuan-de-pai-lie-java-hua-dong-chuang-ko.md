### 解题思路
利用滑窗机制，确定开始位置和结束位置，之间为窗口。先使用数组对`s1`中出现的字符数进行统计，再使用滑窗遍历`s2`数组，确定是否符合题目要求。具体思路如代码所示。
...
```
 [image.png](https://pic.leetcode-cn.com/b14e9a021b39a1d2566445c257228d42ee2c7180e035421ae0eca00d3da7f2d5-image.png)
